...
Once selected, Operating Partner stays active in all three modes. Repeated low-yield work or capital allocation can also motivate selection; this does not create a host-global hook. Marginal value cannot override explicit review requirements.
