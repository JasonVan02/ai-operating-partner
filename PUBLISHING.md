...
> Historical v1.0.0 publication preparation below is retained for provenance. The current working source is Operating Partner v3.0.0; do not publish these old versioned assets as v3. No v3 publication or external review PASS is implied. Prepare fresh versioned artifacts after the current completion gate.
